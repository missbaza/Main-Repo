<?xml version="1.0" encoding="utf-8"?><Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>Rabou_bug</application>
    ...
    <layoutAssignments>
        <layout>Deactivate_Tubular_Users__c-%5BTest%5D brackets Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>FieldTrackingTest__c-FieldTrackingTest Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Global-Global Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Gwilym_Test__mdt-Gwilym Test Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Matthew__c-Matthew Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Nicole__mdt-Nicole Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>SamKing__c-SamKing Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Skye_Test__c-Skye Test Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
